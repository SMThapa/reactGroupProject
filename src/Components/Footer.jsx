...
export const Footer = () => {
  return (
<div className="footer-2 bg-blue-500 pt-6 md:pt-12">
  <div className="container px-4 mx-auto">
    <div className="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">
      ...
      <div className="md:w-1/3 md:px-4 md:text-center mt-12 lg:mt-0">
        ...
        <button className="bg-indigo-600 text-white hover:bg-dark-700 rounded py-2 px-6 md:px-12 transition-colors duration-300">Explore</button>
      </div>
    </div>
  </div>
    ...
    <div className="container px-4 mx-auto">
      <div className="md:flex md:-mx-4 md:items-center">
        <div className="md:flex-1 md:px-4 text-center md:text-left">
          <p className="text-white">© <strong>FWR</strong></p>
        </div>
